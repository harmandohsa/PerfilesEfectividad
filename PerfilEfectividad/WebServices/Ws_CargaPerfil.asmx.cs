                        ...
                        for (int i = 1; i <= a; i += 2)
                        {
                            ...
                            if (NombrePuesto != "")
                            {
                                ...
                                else
                                {
                                    ...
                                    //Valor Educación
                                    int z = i + 1;
                                    string HojaB = excelPackage.Workbook.Worksheets[z].Name;
                                    if ((excelPackage.Workbook.Worksheets[z].Cells[30, 4].Text == "") && (excelPackage.Workbook.Worksheets[z].Cells[31, 4].Text == "") && (excelPackage.Workbook.Worksheets[z].Cells[32, 4].Text == "") && (excelPackage.Workbook.Worksheets[z].Cells[33, 4].Text == "") && (excelPackage.Workbook.Worksheets[z].Cells[34, 4].Text == "") && (excelPackage.Workbook.Worksheets[z].Cells[35, 4].Text == "") && (excelPackage.Workbook.Worksheets[z].Cells[36, 4].Text == ""))
                                    {
                                        HayErrorPuesto = true;
                                        if (Error == "")
                                    ...
                                    {
                                        if (excelPackage.Workbook.Worksheets[z].Cells[30, 4].Text != "")
                                        {
                                            EducacionFormalId = 1;
                                            GradoId = 1;
                                        ...
                                        if (excelPackage.Workbook.Worksheets[z].Cells[31, 4].Text != "")
                                        {
                                            EducacionFormalId = 2;
                                            GradoId = 2;
                                        }
                                            
                                        if (excelPackage.Workbook.Worksheets[z].Cells[32, 4].Text != "")
                                        {
                                            EducacionFormalId = 3;
                                            GradoId = 3;
                                            CarrraId = clPerfil.Get_Carrera(excelPackage.Workbook.Worksheets[z].Cells[32, 5].Text, GradoId);
                                        }
                                        if (excelPackage.Workbook.Worksheets[z].Cells[33, 4].Text != "")
                                        {
                                            EducacionFormalId = 4;
                                            GradoId = 4;
                                            CarrraId = clPerfil.Get_Carrera(excelPackage.Workbook.Worksheets[z].Cells[33, 5].Text, GradoId);
                                        }
                                        if (excelPackage.Workbook.Worksheets[z].Cells[34, 5].Text != "")
                                        {
                                            EducacionFormalId = 5;
                                            GradoId = 5;
                                            CarrraId = clPerfil.Get_Carrera(excelPackage.Workbook.Worksheets[z].Cells[34, 5].Text, GradoId);
                                        }
                                        if (excelPackage.Workbook.Worksheets[z].Cells[35, 5].Text != "")
                                        {
                                            EducacionFormalId = 6;
                                            GradoId = 6;
                                            CarrraId = clPerfil.Get_Carrera(excelPackage.Workbook.Worksheets[z].Cells[35, 5].Text, GradoId);
                                        }
                                        if (excelPackage.Workbook.Worksheets[z].Cells[36, 5].Text != "")
                                        {
                                            EducacionFormalId = 6;
                                            GradoId = 6;
                                            CarrraId = clPerfil.Get_Carrera(excelPackage.Workbook.Worksheets[z].Cells[36, 5].Text, GradoId);
                                        }
                                    }


                                    //Impacto del Error
                                    if ((excelPackage.Workbook.Worksheets[z].Cells[40, 1].Text == "") && (excelPackage.Workbook.Worksheets[z].Cells[41, 1].Text == "") && (excelPackage.Workbook.Worksheets[z].Cells[42, 1].Text == "") && (excelPackage.Workbook.Worksheets[z].Cells[43, 1].Text == "") && (excelPackage.Workbook.Worksheets[z].Cells[44, 1].Text == ""))
                                    {
                                        HayErrorPuesto = true;
                                        if (Error == "")
                                            Error = "<ul><li>No selecciono ninguna opción en la sección de Impacto del Error Hoja " + HojaB + "</li>";
                                        else
                                            Error = Error + Environment.NewLine + "<li>No selecciono ninguna opción en la sección de Impacto del Error Hoja " + HojaB + "</li>";
                                    }
                                    else
                                    {
                                        if (excelPackage.Workbook.Worksheets[z].Cells[40, 1].Text != "")
                                            ImpactoErrorId = 1;
                                        if (excelPackage.Workbook.Worksheets[z].Cells[41, 1].Text != "")
                                            ImpactoErrorId = 2;
                                        if (excelPackage.Workbook.Worksheets[z].Cells[42, 1].Text != "")
                                            ImpactoErrorId = 3;
                                        if (excelPackage.Workbook.Worksheets[z].Cells[43, 1].Text != "")
                                            ImpactoErrorId = 4;
                                        if (excelPackage.Workbook.Worksheets[z].Cells[44, 1].Text != "")
                                            ImpactoErrorId = 5;

                                    }

                                    //Otros Estudios
                                    List<OtrosEstudios> DataOtrosEstudios = new List<OtrosEstudios>();
                                    for (int k = 49; k < 54; k++)
                                    {
                                        if (excelPackage.Workbook.Worksheets[z].Cells[k, 1].Text != "")
                                        {
                                            OtrosEstudios Registro = new OtrosEstudios();
                                            Registro.Curso = excelPackage.Workbook.Worksheets[z].Cells[k, 1].Text;
                                            Registro.Duracion = excelPackage.Workbook.Worksheets[z].Cells[k, 6].Text;
                                            DataOtrosEstudios.Add(Registro);
                                        }
                                    }

                                    //OtrosEstudiosRequeridos
                                    OtrosEstudios = excelPackage.Workbook.Worksheets[z].Cells[55, 1].Text;

                                    //Idiomas
                                    List<Idiomas> DataIdiomas = new List<Idiomas>();
                                    for (int k = 64; k < 67; k++)
                                    {
                                        if (excelPackage.Workbook.Worksheets[z].Cells[k, 1].Text != "")
                                        {
                                            Idiomas Registro = new Idiomas();
                                            Registro.IdiomaId = clPerfil.Get_Idioma(excelPackage.Workbook.Worksheets[z].Cells[k, 1].Text);
                                            if (excelPackage.Workbook.Worksheets[z].Cells[k, 5].Text != "")
                                                Registro.DominioId = 1;
                                            if (excelPackage.Workbook.Worksheets[z].Cells[k, 6].Text != "")
                                                Registro.DominioId = 2;
                                            if (excelPackage.Workbook.Worksheets[z].Cells[k, 7].Text != "")
                                                Registro.DominioId = 3;
                                            DataIdiomas.Add(Registro);
                                        }
                                    }

                                    //Experiencia
                                    List<Experiencia> DataExperiencia = new List<Experiencia>();
                                    for (int k = 72; k < 77; k++)
                                    {
                                        if (excelPackage.Workbook.Worksheets[z].Cells[k, 1].Text != "")
                                        {
                                            Experiencia Registro = new Experiencia();
                                            Registro.TipoTrabajo = excelPackage.Workbook.Worksheets[z].Cells[k, 1].Text;
                                            Registro.Tiempo = excelPackage.Workbook.Worksheets[z].Cells[k, 6].Text;
                                            DataExperiencia.Add(Registro);
                                        }
                                    }

                                    //Insertar Puesto Seccion AyB
                                    if (HayErrorPuesto == false)
                                    {
                                        ...
                                        for (int j = 0; j < DataOtrosEstudios.Count; j++)
                                        {
                                            clPerfil.Insert_DetalleOtrosCursos(PuestoId, PuestoVer, DataOtrosEstudios[j].Curso, DataOtrosEstudios[j].Duracion);
                                        }
                                        for (int j = 0; j < DataIdiomas.Count; j++)
                                        {
                                            clPerfil.Insert_DetalleOtrosIdiomas(PuestoId, PuestoVer, DataIdiomas[j].DominioId, DataIdiomas[j].IdiomaId);
                                        }
