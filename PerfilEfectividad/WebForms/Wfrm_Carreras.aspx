<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Wfrm_Carreras.aspx.cs" Inherits="PerfilEfectividad.WebForms.Wfrm_Carreras" %>
		    ...
		    <div class="kt-portlet__head-toolbar">
			    <div class="kt-portlet__head-wrapper">
				    <div class="kt-portlet__head-actions">
					    <button type="button" id="BtnNuevo" onclick="Nuevo()" data-toggle="modal" data-target="#modalDatos" class="btn btn-primary"><i class="fa fa-plus-circle"></i>Nueva Carrera</button>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group required" >
                                    <label for="txtNombre">Nivel Educativo</label>
...
<script src="../WebScripts/Src_Carreras.js" type="text/javascript"></script>
