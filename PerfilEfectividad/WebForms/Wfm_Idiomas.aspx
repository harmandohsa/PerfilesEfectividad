<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Wfm_Idiomas.aspx.cs" Inherits="PerfilEfectividad.WebForms.Wfm_Idiomas" %>
		    ...
		    <div class="kt-portlet__head-toolbar">
			    <div class="kt-portlet__head-wrapper">
				    <div class="kt-portlet__head-actions">
					    <button type="button" id="BtnNuevo" onclick="Nuevo()" data-toggle="modal" data-target="#modalDatos" class="btn btn-primary"><i class="fa fa-plus-circle"></i>Nuevo Idioma</button>
                    ...
                    <div class="container-fluid">
                        <div class="col-md-6">
                            <div class="form-group required" >
                                <label for="txtNombre">Idioma</label>
