<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Wfrm_SubAreas.aspx.cs" Inherits="PerfilEfectividad.WebForms.Wfrm_SubAreas" %>
		    ...
		    <div class="kt-portlet__head-toolbar">
			    <div class="kt-portlet__head-wrapper">
				    <div class="kt-portlet__head-actions">
					    <button type="button" id="BtnNuevo" onclick="Nuevo()" data-toggle="modal" data-target="#modalDatos" class="btn btn-primary"><i class="fa fa-plus-circle"></i>Nueva sub área</button>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group required" >
                                    <label for="txtNombre">sub área</label>
...
<script src="../WebScripts/Src_SubAreas.js" type="text/javascript"></script>
