<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Wfrm_Pais.aspx.cs" Inherits="PerfilEfectividad.WebForms.Wfrm_Pais" %>
                    ...
                    <div class="container-fluid">
                        <div class="col-md-6">
                            <div class="form-group required" >
                                <label for="txtNombre">País</label>
...
<script src="../WebScripts/SrcPais.js" type="text/javascript"></script>
</asp:Content>
